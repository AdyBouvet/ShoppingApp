...
namespace ShopApp.Migrations
{
    ...
    [Migration("20231116133814_category-connection")]
    partial class categoryconnection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemShoppingList", b =>
                {
                    b.HasOne("ShopApp.Models.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopApp.Models.ShoppingList", null)
                        .WithMany()
